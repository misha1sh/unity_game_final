...
namespace RotaryHeart.Lib.PhysicsExtension
{
    public class SupportWindow : EditorWindow
    {
        ...
        public static void ShowWindow()
        {
            ...
            myWindow.assetName = myWindow.IconContent("<size=20><b><color=" + color + "> Physics Debug Extension</color></b></size>", "", "");
        ...
        void OnGUI()
        {
            ...
            if (GUILayout.Button(review, ReviewBanner, GUILayout.Height(30)))
                Application.OpenURL("https://assetstore.unity.com/packages/tools/physics/physics-debug-extension-88947");
        }
